...
import { getTailwindCode } from "@/lib/component-code"
...
interface ComponentFullWidthCardProps {
  component: ComponentMeta
}

export function ComponentFullWidthCard({ component }: ComponentFullWidthCardProps) {
  ...
  return (
    <Card className={cn("overflow-hidden transition-all", component.isNew && "ring-2 ring-primary/20")}>
