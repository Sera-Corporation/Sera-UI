...
import { getComponentCode, getTailwindCode } from "@/lib/component-code"
...
export function ComponentDialog({ component, open, onOpenChange }: ComponentDialogProps) {
  ...
  const reactCode = getComponentCode(component.id)
  const tailwindCode = getTailwindCode(component.id)
  const ShowcaseComponent = showcaseComponents[component.id]
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            {component.version && <Badge variant="secondary">v{component.version}</Badge>}
          </div>
          ...
          <Tabs defaultValue="tailwind" onValueChange={(value) => setActiveTab(value as "tailwind" | "react")}>
            ...
            <TabsContent value="tailwind" className="relative">
              ...
              <div className="max-h-[300px] overflow-auto rounded-md">
                ...
                >
                  {tailwindCode || "// Tailwind CSS code coming soon for this component"}
                </SyntaxHighlighter>
              </div>
            </TabsContent>
        ...
        <div className="mt-4 flex justify-between">
          <Button variant="outline" asChild>
            <a href={`/docs/components/${component.id}`}>View Documentation</a>
          </Button>
          <Button asChild>
            <a
              href={`https://github.com/yourusername/seraui/tree/main/components/${component.id}`}
              target="_blank"
